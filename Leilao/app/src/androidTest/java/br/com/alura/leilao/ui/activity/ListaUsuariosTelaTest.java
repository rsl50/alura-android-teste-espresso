    ...
    public void listaUsuariosTelaTest() {
        ...
        ViewInteraction textInputEditText = onView(
                allOf(childAtPosition(
                        ...
                        0),
                        isDisplayed()));
        textInputEditText.perform(replaceText("Robson"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.item_usuario_id_com_nome), withText("(1) Robson"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView.check(matches(withText("(1) Robson")));
    }
